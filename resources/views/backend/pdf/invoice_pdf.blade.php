                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="thick-line text-center">Rs.{{ $total_sum }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="no-line"></td>
                                                                    <td class="no-line"></td>
                                                                    ...
                                                                    <td class="no-line text-center">Rs.{{ $payment->discount }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="no-line"></td>
                                                                    <td class="no-line"></td>
                                                                    ...
                                                                    <td class="no-line text-center">Rs.{{ $payment->paid_amount }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="no-line"></td>
                                                                    <td class="no-line"></td>
                                                                    ...
                                                                    <td class="no-line text-center">Rs.{{ $payment->due_amount }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="no-line"></td>
                                                                    <td class="no-line"></td>
                                                                    ...
                                                                    <td class="no-line text-center"><h4 class="m-0">Rs.{{ $payment->total_amount }}</h4></td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
