                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('invoice.pending') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float: right"><i class="fa fa-list"> Pending Invoice List</i></a>
                                        <br><br>
                                        ...
                                        <table class="table table-dark">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td colspan="3">Description: <strong>{{ $invoice->description }}</strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
